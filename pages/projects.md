...
Python (Django, Flask, FastAPI), Ruby (Ruby on Rails), MySQL & PostgreSQL (SQLALchemy, SQLModel), HTML/CSS, Javascript (ReactJS, VueJS), Docker, Git, AWS S3, Websocket.
...
## Some companies I worked with (in reverse chronological order)

{:.companies}
![Otterly Logo](/assets/otto.png){:class="company"}
...
### **[Otterly - All-in-one Project Management Platform for freelancers and solopreneurs](https://otterly.live){:target="_blank"}** | 2024 - Present

I founded and built the Otterly platform from scratch.
